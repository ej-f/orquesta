...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitter_2.setMaximumSize(QtCore.QSize(1204, 604))
        ...
        self.groupbox_terminals.setMinimumSize(QtCore.QSize(120, 235))
        self.groupbox_terminals.setMaximumSize(QtCore.QSize(200, 300))
        ...
        self.groupbox_cwd.setMinimumSize(QtCore.QSize(120, 200))
        self.groupbox_cwd.setMaximumSize(QtCore.QSize(200, 300))
        ...
        self.treeview = OrTreeView(self.groupbox_cwd)
        ...
        self.sciscintilla.setMinimumSize(QtCore.QSize(400, 450))
        self.sciscintilla.setMaximumSize(QtCore.QSize(1000, 1000))
        ...
        self.menu_select = QtGui.QMenu(self.menubar)
        self.menu_select.setObjectName(_fromUtf8("menu_select"))
        self.menu_unselect = QtGui.QMenu(self.menu_select)
        self.menu_unselect.setObjectName(_fromUtf8("menu_unselect"))
        ...
        self.menu_select.addAction(self.action_select_all)
        self.menu_select.addAction(self.action_unselect_all)
        self.menu_select.addAction(self.action_invert)
        ...
        MainWindow.setTabOrder(self.sciscintilla, self.treeview)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupbox_cwd.setTitle(_translate("MainWindow", "Working directory", None))
        ...
        self.menu_select.setTitle(_translate("MainWindow", "S&elect", None))
        self.menu_unselect.setTitle(_translate("MainWindow", "Unselect", None))
        ...
        self.action_select_all.setText(_translate("MainWindow", "All", None))
        self.action_select_all.setShortcut(_translate("MainWindow", "Ctrl+S", None))
        self.action_unselect_all.setText(_translate("MainWindow", "None", None))
        self.action_unselect_all.setShortcut(_translate("MainWindow", "Alt+S", None))
        self.action_about.setText(_translate("MainWindow", "About", None))
        self.action_open_terminals.setText(_translate("MainWindow", "Open Terminals", None))
        self.action_open_terminals.setShortcut(_translate("MainWindow", "Ctrl+O", None))
        self.action_send_move_next.setText(_translate("MainWindow", "Send and move next", None))
        self.action_send_move_next.setShortcut(_translate("MainWindow", "F1", None))
        self.action_send.setText(_translate("MainWindow", "Send", None))
        ...
        self.action_invert.setShortcut(_translate("MainWindow", "Ctrl+I", None))
        self.action_close_terminals.setText(_translate("MainWindow", "Close terminals", None))
        ...
        self.action_edit_config.setText(_translate("MainWindow", "_edit_config", None))
        self.action_edit_config.setToolTip(_translate("MainWindow", "Modify config file", None))
        self.action_open_local_dir.setText(_translate("MainWindow", "_open_dir_in_cwd", None))
        self.action_open_local_dir.setToolTip(_translate("MainWindow", "Open local directory", None))
        self.action_open_local_term.setText(_translate("MainWindow", "_open_term_in_cwd", None))
        self.action_open_local_term.setToolTip(_translate("MainWindow", "Open local terminal in current directory", None))
...
from widgets.ortreeview import OrTreeView
